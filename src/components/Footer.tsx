        ...
        <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="md:col-span-2">
            <h3 className="text-xl font-semibold mb-4">
              Burnaby&apos;s Water Damage Experts
            </h3>
            <div className="h-1 w-16 bg-white mb-6"></div>
            <p className="text-stone-300 mb-6 leading-relaxed">
              Your trusted partner in flood and water damage restoration across Greater Vancouver. Our rapid response team is available 24/7 to protect your property from water damage, with advanced equipment and proven restoration techniques.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-3 text-stone-300">
              <li className="hover:text-white transition-colors duration-300">
                <Link href="https://vancouverflood.com/water-extraction/">
                  Water Extraction
                </Link>
              </li>
              <li className="hover:text-white transition-colors duration-300">
                <Link href="https://vancouverflood.com/drying-and-dehumidification/">
                  Drying & Dehumidification
                </Link>
              </li>
              <li className="hover:text-white transition-colors duration-300">
                <Link href="https://vancouverflood.com/mold-remediation-services-in-vancouver/">
                  Mold Remediation
                </Link>
              </li>
            </ul>
          ...
          <div>
            ...
            <div className="text-stone-300 space-y-4">
              <div>
                ...
                <p className="mt-2 text-white font-semibold">Fast Emergency Response</p>
              </div>
              <div className="pt-4 border-t border-stone-700">
                <a href="tel:778-200-5442" className="flex items-center gap-2 hover:text-white transition-colors duration-300 cursor-pointer mb-3">
                  <Phone size={16} />
                  <p>778-200-5442</p>
                </a>
                <a href="mailto:office@flood911.ca" className="flex items-center gap-2 hover:text-white transition-colors duration-300 cursor-pointer mb-3">
                  <Mail size={16} />
                  <p>office@flood911.ca</p>
                </a>
        ...
        <div className="max-w-7xl mx-auto mt-12 pt-8 border-t border-stone-700">
          <div className="flex flex-col md:flex-row justify-between items-center text-stone-400 text-sm">
            <div className="text-center md:text-left mb-4 md:mb-0">
              <p>© {new Date().getFullYear()} Burnaby Flood. ALL RIGHTS RESERVED</p>
            </div>
